...
router.get("/:id/downloadJSON", ensureAuth, function(req, res){
    const file = "C:/Users/Justin/Desktop/Class/mvc/binary-upload-boom/temp/output.json";
    res.download(file);
    console.log("Sending json to user");
}); 
router.get("/:id/downloadTXT", ensureAuth, function(req, res){
    const file = "C:/Users/Justin/Desktop/Class/mvc/binary-upload-boom/temp/output.txt";
    res.download(file);
